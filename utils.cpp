...
//    std::cout << "closestByteBitIndex: " << closestByteBitIndex << std::endl;
//    std::cout << "closesByteIndex: " << closesByteIndex << std::endl;
//    std::cout << "headBitsSize: " << headBitsSize << std::endl;
//    std::cout << "tailBitsSize: " << tailBitsSize << std::endl;
//    std::cout << "wholeBytesCount: " << wholeBytesCount << std::endl;
